...
/**
 * The error is thrown when trying to verify the user email
 * address using a verification token and the token is
 * either invalid or expired.
 */
export const E_INVALID_EMAIL_TOKEN = class extends Exception {
  static status: number = 400
  static code: string = 'E_INVALID_EMAIL_TOKEN'
  static message: string = 'Invalid or expired email verification token'

  /**
   * Translation identifier. Can be customized
   */
  identifier: string = 'errors.E_INVALID_EMAIL_TOKEN'
